			...
			<div className="animal-grid">
				{animais.map((animal) => (
					...
					>
						...
						<p>
							<strong>Família:</strong> {animal.familia}
						</p>
						<p>
							<strong>Habitat:</strong> {animal.habitat}
						</p>
						<p>
							<strong>Hábito:</strong> {animal.habito}
						</p>
						<p>
						...
						<p>
							<strong>Peçonhento:</strong>{" "}
							{animal.peconhento === "true" ? "Sim" : "Não"}
						</p>
						<p>
							<strong>Agressivo:</strong>{" "}
							{animal.agressivo === "true" ? "Sim" : "Não"}
						</p>
						<button
